...
pub fn day_19() {
    ...
    // println!("{:?}", scanners);
    let (num, loc) = part_one(scanners);
    println!("Part 1: {}", num);
    // test(scanners);
    println!("Part 2: {}", part_two(loc));
}

fn distance(a: &Point, b: &Point) -> (i64, i64, i64) {
...
fn part_one(scanners: Scanners) -> (usize, HashMap<usize, (i64, i64, i64)>) {
...
fn part_two(locations: HashMap<usize, (i64, i64, i64)>) -> i64 {
    let mut best = 0;
